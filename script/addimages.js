...
function modeUPLOAD_2(){
    ...
    $('#confirmbtn').hide()
    $('#confirm').toggle()
    alert('Double click on two areas on the canvas and Your image should appear between the two areas.')
}
...
//this runs when User sees the image they want to upload show up and click the white check
